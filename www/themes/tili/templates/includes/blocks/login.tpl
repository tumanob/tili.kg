<center>
         <p><a style="font-size: 24px;" href="http://tili.kg/wp-login.php?redirect_to={$smarty.server.REQUEST_URI|escape:'url'}">Войти на сайт </a><br /> <a style="font-size: 16px;" href="http://tili.kg/wp-login.php?action=register">Регистрация</a></p>
</center>
