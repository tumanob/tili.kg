...
function add_readygraph_plugin_warning() {
  ...
  if(isset($_GET["readygraph_notice"]) && $_GET["readygraph_notice"] == "dismiss") update_option('readygraph_rsftsb_connect_notice','false');
  if ( $hook_suffix == 'plugins.php' && get_option('readygraph_rsftsb_connect_notice') == 'true' ) {              
