...
class Iso extends \JamesHeinrich\GetID3\Module\Handler
{
	...
	public function ParsePrimaryVolumeDescriptor(&$ISOheader) {
		...
		$thisfile_iso_primaryVD_raw['volume_descriptor_version']     = Utils::LittleEndian2Int(substr($ISOheader,    6, 1));
		...
		$thisfile_iso_primaryVD_raw['volume_space_size']             = Utils::LittleEndian2Int(substr($ISOheader,   80, 4));
		//$thisfile_iso_primaryVD_raw['unused_3']                      =                              substr($ISOheader,   88, 32);
		$thisfile_iso_primaryVD_raw['volume_set_size']               = Utils::LittleEndian2Int(substr($ISOheader,  120, 2));
		$thisfile_iso_primaryVD_raw['volume_sequence_number']        = Utils::LittleEndian2Int(substr($ISOheader,  124, 2));
		$thisfile_iso_primaryVD_raw['logical_block_size']            = Utils::LittleEndian2Int(substr($ISOheader,  128, 2));
		$thisfile_iso_primaryVD_raw['path_table_size']               = Utils::LittleEndian2Int(substr($ISOheader,  132, 4));
		$thisfile_iso_primaryVD_raw['path_table_l_location']         = Utils::LittleEndian2Int(substr($ISOheader,  140, 2));
		$thisfile_iso_primaryVD_raw['path_table_l_opt_location']     = Utils::LittleEndian2Int(substr($ISOheader,  144, 2));
		$thisfile_iso_primaryVD_raw['path_table_m_location']         = Utils::LittleEndian2Int(substr($ISOheader,  148, 2));
		$thisfile_iso_primaryVD_raw['path_table_m_opt_location']     = Utils::LittleEndian2Int(substr($ISOheader,  152, 2));
		...
		$thisfile_iso_primaryVD_raw['file_structure_version']        = Utils::LittleEndian2Int(substr($ISOheader,  881, 1));
		//$thisfile_iso_primaryVD_raw['unused_4']                      = Utils::LittleEndian2Int(substr($ISOheader,  882, 1));
	...
	public function ParseSupplementaryVolumeDescriptor(&$ISOheader) {
		...
		$thisfile_iso_supplementaryVD_raw['volume_descriptor_version'] = Utils::LittleEndian2Int(substr($ISOheader,    6, 1));
		...
		$thisfile_iso_supplementaryVD_raw['volume_space_size']         = Utils::LittleEndian2Int(substr($ISOheader,   80, 4));
		...
		$thisfile_iso_supplementaryVD_raw['volume_set_size']                = Utils::LittleEndian2Int(substr($ISOheader,  120, 2));
		$thisfile_iso_supplementaryVD_raw['volume_sequence_number']         = Utils::LittleEndian2Int(substr($ISOheader,  124, 2));
		$thisfile_iso_supplementaryVD_raw['logical_block_size']             = Utils::LittleEndian2Int(substr($ISOheader,  128, 2));
		$thisfile_iso_supplementaryVD_raw['path_table_size']                = Utils::LittleEndian2Int(substr($ISOheader,  132, 4));
		$thisfile_iso_supplementaryVD_raw['path_table_l_location']          = Utils::LittleEndian2Int(substr($ISOheader,  140, 2));
		$thisfile_iso_supplementaryVD_raw['path_table_l_opt_location']      = Utils::LittleEndian2Int(substr($ISOheader,  144, 2));
		$thisfile_iso_supplementaryVD_raw['path_table_m_location']          = Utils::LittleEndian2Int(substr($ISOheader,  148, 2));
		$thisfile_iso_supplementaryVD_raw['path_table_m_opt_location']      = Utils::LittleEndian2Int(substr($ISOheader,  152, 2));
		...
		$thisfile_iso_supplementaryVD_raw['file_structure_version']         = Utils::LittleEndian2Int(substr($ISOheader,  881, 1));
		//$thisfile_iso_supplementaryVD_raw['unused_4']                       = Utils::LittleEndian2Int(substr($ISOheader,  882, 1));
	...
	public function ParsePathTable() {
		...
		while ($offset < $PathTableSize) {
			...
			$thisfile_iso_pathtable_directories_current['length']           = Utils::LittleEndian2Int(substr($info['iso']['path_table']['raw'], $offset, 1));
			$offset += 1;
			$thisfile_iso_pathtable_directories_current['extended_length']  = Utils::LittleEndian2Int(substr($info['iso']['path_table']['raw'], $offset, 1));
			$offset += 1;
			$thisfile_iso_pathtable_directories_current['location_logical'] = Utils::LittleEndian2Int(substr($info['iso']['path_table']['raw'], $offset, 4));
			$offset += 4;
			$thisfile_iso_pathtable_directories_current['parent_directory'] = Utils::LittleEndian2Int(substr($info['iso']['path_table']['raw'], $offset, 2));
			$offset += 2;
			...
			$thisfile_iso_pathtable_directories_current['name_ascii']       = Utils::iconv_fallback($TextEncoding, $info['encoding'], $thisfile_iso_pathtable_directories_current['name']);
